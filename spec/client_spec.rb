...
describe SIRP do
  ...
  context 'client' do
    ...
    it 'should calculate client session (S) and secret (K)' do
      ...
      # Client keys
      expect(client.S).to eq ''
      expect(client.K).to eq '9bf397a36adb2b5cd65f0a5433ebd96dd6f723fb'
    end
